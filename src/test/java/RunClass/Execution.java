...
public class Execution extends LibGlobal {
	...
	public void startTest() {
		...
		loadUrl("https://uat.shriramcity.com");
	...
	public void testcase(String mobNo, String otp1, String otp2, String otp3, String otp4, String otp5, String otp6,
			String pincode, String panNo, String Username,String Years,String Months,String Gender, String TWFatherName, String TWEmailId, String residentType,
			String duration, String employmentType, String monthSalary   ) throws Exception {
...
//		}
		...
		// Name
		driver.findElement(By.xpath("(//input[@class='toUppercase form-control form-control-material valid'])[2]"))
				.sendKeys(Username);
		Thread.sleep(5000);
...
//		driver.findElement(By.id("TWModeL")).clear();
		...
		s81.selectByVisibleText("X BLADE SINGLE DISCBS6");
		Thread.sleep(2000);
		...
		Thread.sleep(3000);
		driver.findElement(
				By.xpath("/html/body/section/div/div/div/div/div/div[2]/div[4]/section/div[4]/div[1]/button[8]"))
				.click();
