...
public class ExcelUtil {
    ...
    public static ArrayList<Object[]> getDataFromexcel() {
        ...
        try {
            ...
            String s="C:\\Users\\v802\\eclipse-workspace\\Two_Wheeler\\e1data\\66.xlsx";
...
//            String Iterations = reader.getCellData("Sheet1", "Iterations", rowNum);
            ...
            Object ob[] = { mobNo,  otp1,  otp2,  otp3, 
        			 otp4,  otp5,  otp6,  pincode,  panNo, 
        			 Username, Years,Months,  TWFatherName,  TWEmailId,  residentType,
        			 duration,  employmentType,  monthSalary,  Gender};
            myData.add(ob);
        }
        return myData;
    }
    ...
    public static void writeinexcel(String value, int INDEX) throws Exception {
        File fis = new File("C:\\Users\\v802\\eclipse-workspace\\Two_Wheeler\\e1data\\66.xlsx");
